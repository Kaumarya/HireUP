...
import { ArrowLeft, CheckCircle, Star, Zap, Shield, Users, Crown, TrendingUp, BarChart2 } from 'lucide-react';
    ...
    <div style={{ 
      ...
      <section style={{ position: 'relative', paddingTop: '8rem', paddingBottom: '4rem', paddingHorizontal: '1.5rem' }}>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative' }}>
          ...
          >
            ...
            >
              Unlock advanced features and accelerate your career growth. Stand out from the competition with premium tools.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1.5rem' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            {[
              {
                ...
                description: 'Apply to unlimited jobs per month',
                color: '#3B82F6'
              },
              {
                icon: TrendingUp,
          ...
          >
            <Link 
              to="/upgrade-payment?plan=pro&code=111111"
              style={{
                display: 'inline-flex',
                alignItems: 'center',
                gap: '0.75rem',
